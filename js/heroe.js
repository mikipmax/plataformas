function Heroe(imagen, animaciones){
	...
	this.caminar=function(){
		if(this.direccion) this.move(this.vx,0);
				...
				this.attrs.drawFunc=function (a){var b=this.attrs.animation,c=this.attrs.index,d=this.attrs.animations[b][c],e=a.getContext(),f=this.attrs.image;f&&
				e.drawImage(f,d.x,d.y,d.width,d.height,0,0,d.width,d.height)}
				this.setScale({
					x:1
				});
				this.direccion=true;
	...
	this.retroceder=function(){
		if(!this.direccion) this.move(-this.vx,0);
			...
			this.attrs.drawFunc=function (a){var b=this.attrs.animation,c=this.attrs.index,d=this.attrs.animations[b][c],e=a.getContext(),f=this.attrs.image;f&&
				e.drawImage(f,d.x,d.y,d.width,d.height,-d.width,0,d.width,d.height)}
			this.setScale({x:-1});
